...
void			move_keys_handler(mlx_key_data_t keydata, void *player);
...
int				initialize_all(t_player *player, char *map_path, mlx_texture_t **c_textures, mlx_texture_t **d_textures);
